  ...
  return (
    <>
      <div className="z-10 text-main-white font-semibold font-sans text-xl fixed md:relative w-full flex flex-col justify-center md:flex-row md:justify-between md:bg-dark-gray md:px-4">
        ...
        <nav
          ref={toggle}
          className="border-t-4 border-gray-600 p-4 text-base bg-light-gray flex flex-col gap-4 transition-all opacity-0 invisible duration-300 -translate-y-full md:visible md:flex-row md:bg-transparent md:border-0 md:gap-12 md:opacity-100 md:translate-y-0"
