...
function ContactPage() {
  return (
    <div className="flex justify-center items-center h-screen bg-gray-800 flex-col gap-8 text-center">
      <h1 className=" text-5xl md:text-7xl text-main-white font-montserrat font-bold">
        Reach Me Out!
      </h1>
      <div className="flex gap-8">
        <a href="https://www.instagram.com/farizsabili0604/">
          <div className="flex justify-center items-center trasition-all duration-200 hover:fill-neutral-300 hover:bg-yellow-600 hover:-translate-y-2 w-12 h-12 md:w-16 md:h-16 bg-main-yellow rounded-full p-2 md:p-3 fill-black">
            <svg
        ...
        <a href="https://www.linkedin.com/in/ahmad-fariz-sabili-7202b3217/">
          <div className="flex justify-center items-center trasition-all duration-200 hover:fill-neutral-300 hover:bg-yellow-600 hover:-translate-y-2 w-12 h-12 md:w-16 md:h-16 bg-main-yellow rounded-full p-2 md:p-3 fill-black">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-full h-full"
        ...
        <a href="https://github.com/fariz8989/">
          <div className="flex justify-center items-center trasition-all duration-200 hover:fill-neutral-300 hover:bg-yellow-600 hover:-translate-y-2 w-12 h-12 md:w-16 md:h-16 bg-main-yellow rounded-full p-2 md:p-3 fill-black">
        ...
        <a href="https://wa.me/6281318449618">
          <div className="flex justify-center items-center trasition-all duration-200 hover:fill-neutral-300 hover:bg-yellow-600 hover:-translate-y-2 w-12 h-12 md:w-16 md:h-16 bg-main-yellow rounded-full p-2 md:p-3 fill-black">
  ...
  return (
    <>
      <div className="gap-8 p-12 translate-y-16 md:translate-y-0 min-h-screen bg-gray-800 grid md:grid-cols-3">
        ...
        <div>
          <img
            className=" h-72 md:h-full w-full object-cover rounded-md"
        ...
        {/* User Component */}
        <div className="bg-gray-300 rounded-md md:h-1/2 border-8 border-gray-400 p-4 flex-col flex justify-center items-center">
          ...
          <button className="w-3/4 my-4 border-gray-600 rounded-md font-ptsans font-bold bg-main-yellow p-1">BUY NOW</button>
        </div>
      </div>
    </>
  );
